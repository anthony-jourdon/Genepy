...
def initial_strain(Domain,MshRef,Rotation,report=False):
  ...
  dz    = 35.0e3                            # distance from the domain centre in z direction
  angle = np.deg2rad(72.5)                 # angle between the x-axis and the line that passes through the centre of the domain and the centre of the gaussian
